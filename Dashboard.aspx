    ...
    <script>
        ...
        function likeBook(isbn) {
            $.ajax({
                ...
                error: function (error) {
                    alert("Failed to like the book: " + error.responseJSON.Message);
                }
            });
        }

        function dislikeBook(isbn) {
            $.ajax({
                type: "POST",
                url: "Dashboard.aspx/DislikeBook",
                data: JSON.stringify({ isbn: isbn }),
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                success: function (response) {
                    alert("You disliked this book!");
                },
                error: function (error) {
                    alert("Failed to dislike the book: " + error.responseJSON.Message);
                }
            });
        }
        ...
        function rateBook(isbn, rating) {
            $.ajax({
                ...
                error: function (error) {
                    alert("Failed to submit rating: " + error.responseJSON.Message);
                }
            });
        }
    </script>
